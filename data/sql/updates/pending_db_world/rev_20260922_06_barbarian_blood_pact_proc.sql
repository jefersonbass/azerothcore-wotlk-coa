-- Blood Pact (804348): "Direct critical strikes apply Blood Pact."
--
...
-- src/server/game/Spells/Auras/SpellAuras.cpp). 804348 ships ProcFlags 0, so its aura 42
-- (SPELL_AURA_PROC_TRIGGER_SPELL) on TriggerSpell 560522 has never fired.
-- The payload is authored: 560522 carries aura 87 (SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN) and aura 137,
-- both BasePoints 0 / DieSides 1, for duration index 32. Only the gate is missing. Same defect and same
-- shape as rev_20260920_48_bloodmage_ultra_instinct_proc.sql.
--
...
DELETE FROM `spell_proc` WHERE `SpellId` = 804348;
INSERT INTO `spell_proc` (`SpellId`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `ProcFlags`, `SpellTypeMask`, `SpellPhaseMask`, `HitMask`, `AttributesMask`, `DisableEffectsMask`, `ProcsPerMinute`, `Chance`, `Cooldown`, `Charges`) VALUES
(804348, 0, 0, 0, 0, 0, 69972, 1, 2, 2, 0, 0, 0, 0, 0, 0);
