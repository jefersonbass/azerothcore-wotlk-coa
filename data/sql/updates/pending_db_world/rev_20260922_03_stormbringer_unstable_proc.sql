-- Unstable (705723): "Your direct damage critical strikes cause your Stormflow to tick 20% faster for 3 sec."
--
...
-- src/server/game/Spells/Auras/SpellAuras.cpp). 705723 ships ProcFlags 0, so its single effect - aura 42
-- (SPELL_AURA_PROC_TRIGGER_SPELL) on TriggerSpell 707222 - has never fired.
-- The payload is authored: 707222 is aura 108 (SPELL_AURA_ADD_PCT_MODIFIER) with MiscValue 19
-- (SPELLMOD_ACTIVATION_TIME) and BasePoints -21 / DieSides 1 -> 20% faster ticking for duration index 27.
...
DELETE FROM `spell_proc` WHERE `SpellId` = 705723;
INSERT INTO `spell_proc` (`SpellId`, `SchoolMask`, `SpellFamilyName`, `SpellFamilyMask0`, `SpellFamilyMask1`, `SpellFamilyMask2`, `ProcFlags`, `SpellTypeMask`, `SpellPhaseMask`, `HitMask`, `AttributesMask`, `DisableEffectsMask`, `ProcsPerMinute`, `Chance`, `Cooldown`, `Charges`) VALUES
(705723, 0, 0, 0, 0, 0, 69972, 1, 2, 2, 0, 0, 0, 0, 0, 0);
