...
-- All four ids are acquirable: Storm Chaser and Dark Skies sit in CharacterAdvancement, Storm Soul,
-- Electric Field and Perpetual Shock are taught through their class skill lines (SkillLineAbility spell
-- column: 300591 skill 61, 300599 skill 61, 300625 skill 63).
-- Chance stays 0 everywhere: LoadSpellProcs falls back to each record's own ProcChance, which is the
-- tooltip's value (Electric Field 10%, Perpetual Shock 35%, the others 100%).
...
-- Opportune Flux (300598) is the same shape and is also skill-line taught (skill 61); its row lives in
-- rev_20260922_01_stormbringer_opportune_flux_proc.sql.
