...
-- tooltip's value (Electric Field 10%, Storm Chaser 33%, Perpetual Shock 35%, the others 100%).
...
DELETE FROM `spell_proc` WHERE `SpellId` IN (300591, 300598, 300599, 300612, 300625);
