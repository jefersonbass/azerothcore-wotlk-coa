...
-- ProcFlags 69904 = the four direct damage spell classes only ("direct damage dealt", "dealing damage");
-- ProcFlags 69972 = those plus melee and ranged auto attacks, the reviewed shape for a "critical
-- strikes/damage" clause (see rev_20260921_40_ranger_dead_procs.sql) - both exclude periodic, so HoTs
...
(705550, 0, 0, 0, 0, 0, 69904, 1, 2, 0, 0, 0, 0, 0, 0, 0),
(704209, 0, 0, 0, 0, 0, 69904, 1, 2, 0, 0, 0, 0, 0, 0, 0),
