...
{
    std::uint32_t Talent;
    std::array<std::uint32_t, 32> Spells;
...
{{
    ...
    {500117, {{501969, 501970, 501971, 501972, 501973, 501974, 501975, 501976, 501977, 501978, 501979,
               501980, 801722, 500965, 501055, 501880, 501881, 501882, 501883, 501884, 501885, 501886,
               501887, 501888, 504610, 800343, 800344, 803530}}, 0, false},
}};
}
