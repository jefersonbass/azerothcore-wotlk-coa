...
enum ServerConfigs
{
    ...
    CONFIG_CLASSIC_PLUS_STAT_FORMULAS,
    CONFIG_RESPAWN_TIMER_STARTS_AT_DEATH,
    CONFIG_CLASSIC_PLUS_REPUTATION_SPILLOVER,
    ...
    RATE_XP_GLOBAL,
    RATE_XP_PROFESSION,
    RATE_XP_PROFESSION_BASE_FRACTION,
    RATE_XP_PROFESSION_GRAY,
    RATE_XP_PROFESSION_GREEN,
    RATE_XP_PROFESSION_YELLOW,
    RATE_XP_PROFESSION_ORANGE,
    RATE_XP_PROFESSION_MINING,
    RATE_XP_PROFESSION_HERBALISM,
    RATE_XP_PROFESSION_DISENCHANTING,
    RATE_XP_PROFESSION_SKINNING,
    RATE_XP_PROFESSION_FISHING,
    RATE_XP_PROFESSION_BLACKSMITHING,
    RATE_XP_PROFESSION_JEWELCRAFTING,
    RATE_XP_PROFESSION_ALCHEMY,
    RATE_XP_PROFESSION_ENCHANTING,
    RATE_XP_PROFESSION_LEATHERWORKING,
    RATE_XP_PROFESSION_FIRST_AID,
    RATE_XP_PROFESSION_COOKING,
    RATE_XP_PROFESSION_ENGINEERING,
    RATE_XP_PROFESSION_TAILORING,
    RATE_XP_PROFESSION_LOCKPICKING,
    RATE_XP_PROFESSION_INSCRIPTION,
    RATE_XP_KILL,
    RATE_XP_KILL_TBC,
    RATE_XP_KILL_WOTLK,
    RATE_XP_ELITE,
    RATE_XP_DUNGEON_ELITE,
    RATE_XP_BG_KILL_AV,
    RATE_XP_BG_KILL_WSG,
    RATE_XP_BG_KILL_AB,
