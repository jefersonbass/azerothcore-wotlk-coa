...
| `modules/mod-ascension-compat/src/AscensionCompat.cpp` (`AscensionCompatLevelScalingScript`, from line ~6064) | the creature half: lift the **object** |
