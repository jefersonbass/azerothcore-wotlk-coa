...
MODULE = ROOT / 'modules/mod-ascension-compat'
...
''')
        include_dirs = [out, MODULE / 'src', ROOT / 'src/common', ROOT / 'src/common/Utilities',
        ...
        command += [str(out / 'main.cpp'), str(MODULE / 'src/AscensionCoAConfig.cpp'), '-o', str(out / 'test')]
